...
navigator.geolocation.getCurrentPosition(position => {
  ...
  /*/api/forum/weather?lon=${longitude}&lat=${latitude}*/
  get(`/api/forum/weather?lon=${longitude}&lat=${latitude}`, data => {
  ...
  get(`/api/forum/weather?lon=116.40529&lat=39.90499`, data => {
    Object.assign(weather, data)
    weather.success = true
  })
}, {
...
<!--    <div style="margin-top: 10px;display: flex; flex-direction: column;gap:20px">
   ...
   <div style="width: 280px">
      <div style="position: sticky;top: 20px">
        <light-card>
          <div class="collect-list-button" @click="userTopic = true">
            <span><el-icon><FolderOpened /></el-icon> 查看我的帖子</span>
        ...
        <light-card style="margin-top: 10px">
          ...
          <div style="font-size: 14px;margin: 10px;color: grey">
            长沙理工大学（CSUST） ，简称为长理或长沙理工 ，
            位于湖南省长沙市天心区 ，为中华人民共和国交通运输部和湖南省人民政府共建高校
            ，是国家“中西部高校基础能力建设工程”高校、湖南省“国内一流大学建设高校”（A类） 。
          </div>
        </light-card>
        <light-card style="margin-top: 10px">
          <div style="font-weight: bold">
    ...
    <topic-user-list :show="userTopic" @close="userTopic= false"/>
  </div>
</template>
